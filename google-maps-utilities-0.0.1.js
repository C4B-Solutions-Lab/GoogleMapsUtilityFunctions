/*!
 * Google Maps JavaScript library v0.0.1
...
(function (window) {
    ...
    var _baseAddress = '/dabrowski-software-development/our_roots/';
    var _ourHomeIconUrl = _baseAddress + 'images/map_location_icons/home.png';
    var _websiteVisitorIconUrl = _baseAddress + 'images/map_location_icons/visitor.png';
    ...
    var _relativePathToMapCriticalDataStorage = _baseAddress + '/upload/our_origins.txt';
    ...
    function loadMapCriticalData_Internal(callbackFunction) {
        ...
        $(temporaryContainer).load(_relativePathToMapCriticalDataStorage, doInternalConversion_Internal(callbackFunction));
    }
